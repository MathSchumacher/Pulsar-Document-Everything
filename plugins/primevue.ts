...
const pt = {
  dropdown: {
    ...
    item: ({ context }: any) => ({
      class: `
        ...
        flex
        items-center
        ${context.selected ? 'bg-primary hover:bg-primary/80' : ''}
        rounded-md
        text-primary
        hover:bg-primary/20
  ...
  inputtext: {
    root: 'w-full h-10 bg-secondary/10 border border-primary/30 text-primary/80 placeholder:text-primary/30 focus:border-primary/50 focus:shadow-none duration-300'
  },
  button: {
    root: 'justify-center items-center bg-secondary/10 hover:bg-primary/80 p-0 border border-primary/30 focus:shadow-none'
  },
  textarea: {
    root: 'w-full max-h-[130px] rounded-md bg-secondary/10 text-primary/80 placeholder:text-primary/30 border border-primary/30 focus:border-primary/50 focus:shadow-none duration-300'
  },
  scrollpanel: {
    root: 'w-full',
    wrapper: 'w-auto',
