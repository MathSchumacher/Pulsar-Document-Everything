...
<template>
  <header class="w-full min-h-[500px] flex flex-col items-center gap-3 pt-14">
    ...
    <a
      ...
      class="features-button-gradient flex items-center gap-3 max-w-[290px] min-h-[37px] max-lg:mb-2 border border-solid border-primary/70 rounded-[10px] px-4 duration-300 cursor-pointer"
    >
      <SparklingIcon class="w-[21px] fill-white/70" />
      <p class="features-text-gradient text-base text-primary/80">
        {{ t('homepage.header-feature-title') }}
      </p>
    </a>
    
    <h1 class="header-title-gradient text-center text-[40px] lg:text-[50px] 2xl:text-[70px] leading-[50px] lg:leading-[75px] font-medium pb-3">
    ...
    <StarsRain :amount="40" :max-speed="8" :min-speed="2" :max-size="3" class="w-[85%] max-w-[1400px] mt-12" />
...
.features-button-gradient:hover {
...
.editor-image-gradient {
  ...
  background: linear-gradient(0deg, rgba(15,17,27,1) 15%, rgba(15,17,27,0.5) 100%); 
}
</style>
